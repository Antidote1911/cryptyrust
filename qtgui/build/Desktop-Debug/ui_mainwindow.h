...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        menu_Quit->setObjectName("menu_Quit");
        menu_AboutQt = new QAction(MainWindow);
        menu_AboutQt->setObjectName("menu_AboutQt");
        ...
        actionAes256Gcm->setObjectName("actionAes256Gcm");
        actionAes256Gcm->setCheckable(true);
        actiondeoxys = new QAction(MainWindow);
        actiondeoxys->setObjectName("actiondeoxys");
        actiondeoxys->setCheckable(true);
        actionChacha20Poly1305 = new QAction(MainWindow);
        actionChacha20Poly1305->setObjectName("actionChacha20Poly1305");
        ...
        gridLayout->addWidget(progBar, 1, 0, 1, 1);
        ...
        menuConfig->addAction(actionCrypto);
