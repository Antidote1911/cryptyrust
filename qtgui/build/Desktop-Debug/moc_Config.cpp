...
Q_CONSTINIT const QMetaObject Config::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6ConfigE_t,
        ...
        QtPrivate::TypeAndForceComplete<ConfigKey, std::false_type>
    >,
    nullptr
} };
...
void Config::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->changed((*reinterpret_cast< std::add_pointer_t<ConfigKey>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Config::*)(ConfigKey );
            if (_q_method_type _q_method = &Config::changed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Config::changed(ConfigKey _t1)
{
